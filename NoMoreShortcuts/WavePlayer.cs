...
class WaveStream : Stream
{
    ...
    public static void PlaySound(string filePath, int volume = 25)
    {
        try
        {
            ...
            if (volume > 100) volume = MaxVolume;

            wvStream.Volume = volume;
        ...
        {
            Logger.Log("Error: PlaySound - file " + filePath + " - " + e.Message);
        }
